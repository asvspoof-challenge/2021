...
# GMM pickle file
dict_file = 'gmm_PA_lfcc.pkl'
dict_file_final = 'gmm_lfcc_asvspoof21_pa.pkl'

# configs - train & dev data - if you change these datasets
db_folder = '/path/to/ASVspoof_root/'
train_folders = [db_folder + 'PA/ASVspoof2019_PA_train/flac/']  # [db_folder + 'PA/ASVspoof2019_PA_train/flac/', db_folder + 'PA/ASVspoof2019_PA_dev/flac/']
train_keys = [db_folder + 'PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.train.trn.txt']  # [db_folder + 'PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.train.trn.txt', db_folder + 'PA/ASVspoof2019_PA_cm_protocols/ASVspoof2019.PA.cm.dev.trn.txt']
