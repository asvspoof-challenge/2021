...
DF_scoring_path = 'DF_cm_scores';
DF_scoring_filename = 'DF_CQCC-GMM_cm_scores.txt';
...
if use_preTrained_models
    ...
    url = 'http://www.asvspoof.org/asvspoof2021/pre_trained_DF_CQCC-GMM.zip';
    outfilename = websave('preTrained/pre_trained_DF_CQCC-GMM.zip',url);
    unzip(outfilename,'preTrained');
    
    load pre_trained_DF_CQCC-GMM.mat
...
% Read eval protocol
pathToDatabase21 = fullfile(pathToASVspoof21, 'DF');
evalProtocolFile = fullfile(pathToDatabase21, 'ASVspoof2021_DF_eval', 'ASVspoof2021.DF.cm.eval.trl.txt');
...
if ~exist(DF_scoring_path,'dir')
    mkdir(DF_scoring_path);
end
fid = fopen(fullfile(DF_scoring_path,DF_scoring_filename), 'w');
